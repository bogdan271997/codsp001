	...
	void Sound::SND_SetChannelVolumes(const float* channelvolume, int priority, int fademsec)
	{
		...
		if (Game::g_snd->entchannel_count > 0)
		{
			...
			for (int chanIndex = 0; chanIndex < Game::g_snd->entchannel_count; ++chanIndex)
			{
				...
				if (chanIndex == Game::SND_GetEntChannelFromName("music") 
				|| chanIndex == Game::SND_GetEntChannelFromName("music_rear") 
				|| chanIndex == Game::SND_GetEntChannelFromName("music2") 
				|| chanIndex == Game::SND_GetEntChannelFromName("music3") 
				|| chanIndex == Game::SND_GetEntChannelFromName("radio1") 
				|| chanIndex == Game::SND_GetEntChannelFromName("radio2") 
				|| chanIndex == Game::SND_GetEntChannelFromName("musicnopause"))
				{
				...
				else if (chanIndex == Game::SND_GetEntChannelFromName("voice") 
				|| chanIndex == Game::SND_GetEntChannelFromName("mission") 
				|| chanIndex == Game::SND_GetEntChannelFromName("announcer") 
				|| chanIndex == Game::SND_GetEntChannelFromName("zombievoice"))
				{
