...
//#define DRAW_DEV_VERSION

#define MO_EXECUTABLE_VERSION "1.0"
#define MO_BUILD_NUMBER "138"
#define MO_BUILD_STATE "Playable"

#define MW1CR_EXECUTABLE_VERSION "1.0"
#define MW1CR_BUILD_NUMBER "114"
#define MW1CR_BUILD_STATE "Playable"

#define COD2R_EXECUTABLE_VERSION "1.0"
#define COD2R_BUILD_NUMBER "001"
#define COD2R_BUILD_STATE "Pre-Playable"
...
#pragma pack(pop)
	...
	enum
	{
		...
		PMF_MANTLE = 1 << 2,
		PMF_LADDER = 1 << 3,
		PMF_BACKWARDS_JUMP = 1 << 5,
		PMF_LADDER_DOWN = (1 << 3) | (1 << 5),
...
#pragma pack(pop)
	...
	*/
	...
	enum StringList_Size
	{
		STRINGLIST_SIZE = 0x7000,
	};
}
